...
class VisitorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create visitor" do
    assert_difference("Visitor.count") do
      post visitors_url, params: { visitor: { cpf: @visitor.cpf, name: @visitor.name, phone: @visitor.phone, photo: @visitor.photo, rg: @visitor.rg } }
    end
  ...
  test "should update visitor" do
    patch visitor_url(@visitor), params: { visitor: { cpf: @visitor.cpf, name: @visitor.name, phone: @visitor.phone, photo: @visitor.photo, rg: @visitor.rg } }
